...
func (s *decimalTestSuite) TestDecCeil() {
	testCases := []struct {
		...
		{sdk.NewDecWithPrec(1000000000000000, sdk.Precision), sdk.NewDec(1)},
		{sdk.NewDecWithPrec(-1000000000000000, sdk.Precision), sdk.ZeroDec()},
		{sdk.ZeroDec(), sdk.ZeroDec()},
		{sdk.NewDecWithPrec(900000000000000000, sdk.Precision), sdk.NewDec(1)},
		{sdk.NewDecWithPrec(4001000000000000000, sdk.Precision), sdk.NewDec(5)},
		{sdk.NewDecWithPrec(-4001000000000000000, sdk.Precision), sdk.NewDec(-4)},
		{sdk.NewDecWithPrec(4700000000000000000, sdk.Precision), sdk.NewDec(5)},
		{sdk.NewDecWithPrec(-4700000000000000000, sdk.Precision), sdk.NewDec(-4)},
	}
...
func (s *decimalTestSuite) TestPower() {
	testCases := []struct {
		...
		{sdk.OneDec(), 10, sdk.OneDec()},
		{sdk.NewDecWithPrec(5, 1), 2, sdk.NewDecWithPrec(25, 2)},
		{sdk.NewDecWithPrec(2, 1), 2, sdk.NewDecWithPrec(4, 2)},
		{sdk.NewDecFromInt(sdk.NewInt(3)), 3, sdk.NewDecFromInt(sdk.NewInt(27))},
		{sdk.NewDecFromInt(sdk.NewInt(-3)), 4, sdk.NewDecFromInt(sdk.NewInt(81))},
		{sdk.NewDecWithPrec(1414213562373095049, 18), 2, sdk.NewDecFromInt(sdk.NewInt(2))},
	}
...
func (s *decimalTestSuite) TestApproxRoot() {
	testCases := []struct {
		...
		{sdk.OneDec(), 10, sdk.OneDec()},
		{sdk.NewDecWithPrec(25, 2), 2, sdk.NewDecWithPrec(5, 1)},
		{sdk.NewDecWithPrec(4, 2), 2, sdk.NewDecWithPrec(2, 1)},
		{sdk.NewDecFromInt(sdk.NewInt(27)), 3, sdk.NewDecFromInt(sdk.NewInt(3))},
		{sdk.NewDecFromInt(sdk.NewInt(-81)), 4, sdk.NewDecFromInt(sdk.NewInt(-3))},
		{sdk.NewDecFromInt(sdk.NewInt(2)), 2, sdk.NewDecWithPrec(1414213562373095049, 18)},
		{sdk.NewDecWithPrec(1005, 3), 31536000, sdk.MustNewDecFromStr("1.000000000158153904")},
		{sdk.SmallestDec(), 2, sdk.NewDecWithPrec(1, 9)},
		{sdk.SmallestDec(), 3, sdk.MustNewDecFromStr("0.000000999999999997")},
		{sdk.NewDecWithPrec(1, 8), 3, sdk.MustNewDecFromStr("0.002154434690031900")},
	}
...
func (s *decimalTestSuite) TestApproxSqrt() {
	testCases := []struct {
		...
		{sdk.OneDec(), sdk.OneDec()},
		{sdk.NewDecWithPrec(25, 2), sdk.NewDecWithPrec(5, 1)},
		{sdk.NewDecWithPrec(4, 2), sdk.NewDecWithPrec(2, 1)},
		{sdk.NewDecFromInt(sdk.NewInt(9)), sdk.NewDecFromInt(sdk.NewInt(3))},
		{sdk.NewDecFromInt(sdk.NewInt(-9)), sdk.NewDecFromInt(sdk.NewInt(-3))},
		{sdk.NewDecFromInt(sdk.NewInt(2)), sdk.NewDecWithPrec(1414213562373095049, 18)},
	}
