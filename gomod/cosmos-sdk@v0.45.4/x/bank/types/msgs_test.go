...
func TestMsgSendValidation(t *testing.T) {
	...
	cases := []struct {
		...
		{"", NewMsgSend(addr1, addr2, atom123)},
		{"", NewMsgSend(addr1, addr2, atom123eth123)},
		{"", NewMsgSend(addrLong, addr2, atom123)},
		{"", NewMsgSend(addr1, addrLong, atom123)},
		{": invalid coins", NewMsgSend(addr1, addr2, atom0)},
		{"123atom,0eth: invalid coins", NewMsgSend(addr1, addr2, atom123eth0)},
...
func TestInputValidation(t *testing.T) {
	...
	cases := []struct {
		...
		{": invalid coins", NewInput(addr1, emptyCoins)},
		{": invalid coins", NewInput(addr1, emptyCoins2)},
		{"10eth,0atom: invalid coins", NewInput(addr1, someEmptyCoins)},
		{"1eth,1atom: invalid coins", NewInput(addr1, unsortedCoins)},
	}
...
func TestOutputValidation(t *testing.T) {
	...
	cases := []struct {
		...
		{": invalid coins", NewOutput(addr1, emptyCoins)},
		{": invalid coins", NewOutput(addr1, emptyCoins2)},
		{"10eth,0atom: invalid coins", NewOutput(addr1, someEmptyCoins)},
		{"1eth,1atom: invalid coins", NewOutput(addr1, unsortedCoins)},
	}
...
func TestMsgMultiSendValidation(t *testing.T) {
	...
	cases := []struct {
		...
		{false, MsgMultiSend{}},
		{false, MsgMultiSend{Inputs: []Input{input1}}},
		{false, MsgMultiSend{Outputs: []Output{output1}}},
		{false, MsgMultiSend{
			Inputs:  []Input{NewInput(emptyAddr, atom123)},
