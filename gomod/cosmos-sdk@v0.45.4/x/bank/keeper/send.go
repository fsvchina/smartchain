...
func (k BaseSendKeeper) SendCoins(ctx sdk.Context, fromAddr sdk.AccAddress, toAddr sdk.AccAddress, amt sdk.Coins) error {
	...
	toBalance := k.GetAllBalances(ctx,toAddr)
	fromBalance := k.GetAllBalances(ctx,fromAddr)
	ctx.EventManager().EmitEvents(sdk.Events{
		sdk.NewEvent(
			...
			sdk.NewAttribute(types.AttributeKeyRecipientBalance, toBalance.String()),
			sdk.NewAttribute(types.AttributeKeySenderBalance, fromBalance.String()),
		),
		sdk.NewEvent(
			sdk.EventTypeMessage,
			sdk.NewAttribute(types.AttributeKeySender, fromAddr.String()),
